...
hora_trabalho = float(input('Informe o valor da hora trabalhada: '))
horas = float(input('Informe o total de horas trabalhadas: '))
#Cálculo dos encargos
salario = hora_trabalho * horas
if(salario <= 900):
    ir = 0
...
print('INSS: R$ {}'.format(round(salario * 0.10, 1)))
print('FGTS: R$ {}'.format(round(salario * 0.11, 1)))
print('Total dos descontos: R$ {}'.format(round(salario * (ir + 0.10), 1)))
print('Salário líquido: R$ {}'.format(round(salario * (1 - ir - 0.10), 1)))
